...
exports.getMyVolunteering = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to fetch your volunteer applications", error: error.message });
  }
};
...
exports.updateVolunteerHours = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to update hours", error: error.message });
  }
};